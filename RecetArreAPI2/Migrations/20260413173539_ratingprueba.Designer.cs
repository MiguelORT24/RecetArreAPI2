...
namespace RecetArreAPI2.Migrations
{
    ...
    [Migration("20260413173539_ratingprueba")]
    partial class ratingprueba
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecetArreAPI2.Models.Rating", b =>
                {
                    ...
                    b.Property<DateTime>("CalificadoUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValueSql("CURRENT_TIMESTAMP");
                    ...
                    b.HasIndex("RecetaId", "CalificadoPorUsuarioId")
                        .IsUnique();
            ...
            modelBuilder.Entity("RecetArreAPI2.Models.Rating", b =>
                {
                    b.HasOne("RecetArreAPI2.Models.ApplicationUser", "CalificadoPorUsuario")
                        .WithMany()
